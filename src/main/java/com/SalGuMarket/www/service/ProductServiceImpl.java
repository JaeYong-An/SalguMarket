...
public class ProductServiceImpl implements ProductService{
	...
	@Override
	public List<ProductVO> getMySaleList(String email) {
		return productMapper.getMySaleList(email);
	}

	@Override
	public List<ProductVO> getMyBuyList(String email) {
		return productMapper.getMyBuyList(email);
	}

	@Override
	public int updateProductState0(int productId) {
		return productMapper.updateProductState0(productId);
	}
	
	@Override
	public int updateProductState1(int productId) {
		return productMapper.updateProductState1(productId);
	}

	@Override
	public int updateProductState2(int productId) {
		return productMapper.updateProductState2(productId);
	}

	@Override
	public int updateProductState3(int productId) {
		return productMapper.updateProductState3(productId);
	}
}
